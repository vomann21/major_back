...
const startUrl = 'https://www.amazon.in/Lenovo-IdeaPad-i5-12450H-Warranty-83ER008DIN/product-reviews/B0CNVH114V/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews19.csv', csv, (err) => {
            if (err) throw err;
