...
const startUrl = 'https://www.amazon.in/HP-Pavilion-Anti-Glare-Graphics-14-dv1001TU/product-reviews/B09MH5MLYP/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews31.csv', csv, (err) => {
            if (err) throw err;
