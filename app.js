...
const startUrl = 'https://www.flipkart.com/search?q=laptops&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('flip_laptop.csv', csv, (err) => {
            if (err) throw err;
