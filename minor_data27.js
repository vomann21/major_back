...
const startUrl = 'https://www.amazon.in/HP-Micro-Edge-Anti-Glare-15s-fq5111TU/product-reviews/B0B6F5V23N/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews27.csv', csv, (err) => {
            if (err) throw err;
