...
const startUrl = 'https://www.amazon.in/Lenovo-Anti-Glare-Warranty-Platinum-81WQ00NXIN/product-reviews/B0B7R7HFKL/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews7.csv', csv, (err) => {
            if (err) throw err;
