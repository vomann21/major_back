...
const startUrl = 'https://www.amazon.in/Lenovo-IdeaPad-Warranty-Platinum-81X800LGIN/product-reviews/B0B2RBP83P/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews6.csv', csv, (err) => {
            if (err) throw err;
