...
const startUrl = 'https://www.amazon.in/Lenovo-IdeaPad-Windows-Warranty-82VG00EVIN/product-reviews/B0CJLP39RS/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews11.csv', csv, (err) => {
            if (err) throw err;
