...
const startUrl = 'https://www.amazon.in/Lenovo-IdeaPad-Fingerprint-Graphite-82FGO1H9IN/product-reviews/B09M423NVT/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews14.csv', csv, (err) => {
            if (err) throw err;
