...
# combined_df.to_csv('combined_json.json', index=False)

import pandas as pd

# Assuming your DataFrame is named 'all_products_df'
# Replace 'your_output_file.json' with the desired file name
