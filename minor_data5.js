...
const startUrl = 'https://www.amazon.in/Lenovo-Ideapad-Backlit-Keyboard-82XQ008VIN/product-reviews/B0CD4BQ4SF/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews5.csv', csv, (err) => {
            if (err) throw err;
