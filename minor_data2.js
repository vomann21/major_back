...
const startUrl = 'https://www.amazon.in/HP-i3-1215U-15-6-inch-Graphics-Speakers/product-reviews/B0BP2M7CCS/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews2.csv', csv, (err) => {
            if (err) throw err;
