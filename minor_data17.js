...
const startUrl = 'https://www.amazon.in/Lenovo-IdeaPad-39-62cms-Platinum-81WQ003LIN/product-reviews/B08TQQ4ZHM/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews17.csv', csv, (err) => {
            if (err) throw err;
