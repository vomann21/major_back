...
const startUrl = 'https://www.amazon.in/Lenovo-IdeaPad-39-62cm-Windows-82RK011EIN/product-reviews/B0CMGZCDRW/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews16.csv', csv, (err) => {
            if (err) throw err;
