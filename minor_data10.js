...
const startUrl = 'https://www.amazon.in/Lenovo-IdeaPad-39-62cm-300nits-82K20289IN/product-reviews/B0CL5L59Z9/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews10.csv', csv, (err) => {
            if (err) throw err;
