...
const startUrl = 'https://www.amazon.in/HP-Anti-Glare-Graphics-15s-eq2213AU/product-reviews/B0BQMZG1SL/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews12.csv', csv, (err) => {
            if (err) throw err;
