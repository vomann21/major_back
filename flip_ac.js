...
const startUrl = 'https://www.flipkart.com/search?q=ac&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('flip_ac.csv', csv, (err) => {
            if (err) throw err;
