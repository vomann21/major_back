...
const startUrl = 'https://www.amazon.in/Lenovo-i3-1115G4-Warranty-Platinum-81X800LCIN/product-reviews/B0B9YHX39M/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews15.csv', csv, (err) => {
            if (err) throw err;
