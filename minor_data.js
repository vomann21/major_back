...
const startUrl = 'https://www.amazon.in/Dell-14-Rheinland-Certified-Comfortview/product-reviews/B0BQJ9HZPP/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews.csv', csv, (err) => {
            if (err) throw err;
