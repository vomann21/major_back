...
const startUrl = 'https://www.amazon.in/HP-Pavilion-Micro-Edge-Graphics-14-dv2014TU/product-reviews/B0B1M9HYBT/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews30.csv', csv, (err) => {
            if (err) throw err;
