...
const startUrl = 'https://www.amazon.in/Lenovo-IdeaPad-Laptop-Windows-82R400ERIN/product-reviews/B0CP2KRYLM/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews13.csv', csv, (err) => {
            if (err) throw err;
