...
const startUrl = `https://www.amazon.in/s?k=watch+for+women&crid=FQOD370TKTQA&sprefix=watch+for+women%2Caps%2C228&ref=nb_sb_noss_1`
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amaz_womens_watches_demo.csv', csv, (err) => {
            if (err) throw err;
