...
const startUrl = 'https://www.amazon.in/Lenovo-39-62cm-Antiglare-Windows-82KDA01EIH/product-reviews/B0B1DHXZDQ/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews';
...
scrapeLaptopData(startUrl)
    .then((data) => {
        ...
        fs.writeFile('amazon_product_reviews20.csv', csv, (err) => {
            if (err) throw err;
